...
async def create_track_card(track_title, artist_name, cover_url=None):
    ...
    try:
        ...
        logger.error("Color detection failed")
    ...
    draw.text((text_x, title_y), track_title, fill=text_color, font=font_title, anchor="mm")
    draw.text((text_x, artist_y), artist_name, fill=text_color, font=font_artist, anchor="mm")
    ...
    return output  # Возвращаем объект BytesIO для передачи в discord.File
